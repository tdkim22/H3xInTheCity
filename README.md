...
To run your code in the terminal, navigate to the folder where your script is and run `python your_code.py`. To install packages permanently, run `pip install --user package_name`.
